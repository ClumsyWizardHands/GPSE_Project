"""
GPSE Main Crew - Global Coverage Version
Removes China-US-Russia bias for comprehensive global analysis
"""
...
class GPSECrew:
    """GPSE Crew with Global Coverage"""
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.info("GPSE Crew initialized with Global Coverage")
...
def main():
    ...
    try:
        ...
        print("Global Coverage Version - No Regional Bias")
        print("="*60 + "\n")
        
        print(f"Execution started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
        print(f"Storage directory: {os.environ['CREWAI_STORAGE_DIR']}")
        
        logger.info("Starting GPSE with Global Coverage...")
