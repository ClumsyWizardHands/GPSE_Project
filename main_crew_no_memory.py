...
class GPSECrew:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.news_tool = news_analysis_tool
            self.analysis_tool = strategic_analysis_tool
            self.synthesis_tool = pattern_synthesis_tool
    ...
    def geo_analyst(self) -> Agent:
        ...
        return Agent(
            ...
            tools=[self.analysis_tool, self.synthesis_tool],
            llm_config=self.llm_config,
            max_iter=3,
            verbose=True
        )
    ...
    def scout_task(self) -> Task:
        ...
        return Task(
            ...
            Requirements:
            - Identify 5-7 most significant developments
            ...
            - Key Developments (bullet points with sources)
