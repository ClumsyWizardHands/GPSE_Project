"""
Fixed GPSE Crew Implementation without BaseTool field issues
"""
import os
import sys
...
class GPSECrew:
    """Fixed Geopolitical Grand Strategy Engine Crew"""
    ...
    def _create_tasks(self):
        ...
        self.document_archive_task = Task(
            ...
            context=[self.analyze_strategy_task],
...
def main():
    ...
    try:
        logger.info("=== Starting GPSE Crew (Fixed Version) ===")
