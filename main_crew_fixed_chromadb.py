"""
GPSE Main Crew - ChromaDB Fix Version
Temporarily disables memory to avoid ChromaDB permission errors
"""
...
class GPSECrewFixedFinal():
    ...
    def __init__(self, inputs: Optional[Dict[str, Any]] = None):
        ...
        logger.info("Initialized GPSE Crew - CHROMADB FIX VERSION")
    ...
    def prepare_analysis(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info("=" * 60)
        logger.info("GPSE - CHROMADB FIX VERSION")
        logger.info("=" * 60)
...
KEEP TOTAL OUTPUT UNDER 2000 WORDS to avoid context issues."""
        ...
        return Agent(
            ...
            max_iter=5,
            memory=False,  # Disabled due to ChromaDB issue
            verbose=True,
...
def main():
    ...
    try:
        ...
        logger.info("=" * 60)
        logger.info("EXECUTING CHROMADB FIX CREW...")
        logger.info("Memory temporarily disabled to avoid permission issues")
        logger.info("=" * 60)
